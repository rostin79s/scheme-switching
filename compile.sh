...
cgeist test/test.cpp -S -O3 -raise-scf-to-affine --polyhedral-opt > src/test.mlir
mlir-opt -affine-super-vectorize="virtual-vector-size=20 test-fastest-varying=0 vectorize-reductions=true" src/test.mlir -o src/output.mlir
mlir-opt -lower-affine src/output.mlir -o src/output1.mlir
