...
# mlir-opt --affine-super-vectorizer-test --vectorize-affine-loop-nest --vectorize-loops src/test.mlir -o src/output.mlir
# mlir-opt --convert-vector-to-scf src/output.mlir -o src/output1.mlir
cd src/build
