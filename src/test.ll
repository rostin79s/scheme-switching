...
define dso_local noundef i32 @_Z6rostinii(i32 noundef %0, i32 %1) local_unnamed_addr #3 {
  %3 = mul nsw i32 %0, %0
  %4 = add nsw i32 %3, -2
  ret i32 %4
}
...
define dso_local noundef i32 @main() local_unnamed_addr #4 {
  %1 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 1022)
...
21:                                               ; preds = %14
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %11)
  ...
  %26 = tail call noundef signext i8 %25(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %11, i8 noundef signext 10)
  br label %27

27:                                               ; preds = %18, %21
  %28 = phi i8 [ %20, %18 ], [ %26, %21 ]
  %29 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %1, i8 noundef signext %28)
  %30 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %29)
  ret i32 0
}
